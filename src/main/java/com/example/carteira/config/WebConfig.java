        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/api/**") // Aplica a configuração a todos os endpoints que começam com /api
                        .allowedOrigins("http://localhost:3000","http://localhost:3002", "https://finance-portfolio-front-2.onrender.com/,https://main.d1xdpfpvrjro0q.amplifyapp.com")// Permite requisições SOMENTE desta origem
